...
import SpikeJump from "c:/Users/ryanj/Documents/COLLEGENOTES/CSE/CSE380/HW4/src/Homework4/Enemies/SpikeJump";
...
export default class EnemyController extends StateMachineAI {
	...
	initializeAI(owner: GameNode, options: Record<string, any>){
		...
		this.spike = options.spike ? options.spike : false;
		...
		let spikejump = new SpikeJump(this, owner);
		this.addState(EnemyStates.SPIKEJUMP, spikejump);
	...
	changeState(stateName: string): void {
		...
		else if(stateName === EnemyStates.SPIKEJUMP){
			this.stack.push(this.stateMap.get(stateName));
		}
