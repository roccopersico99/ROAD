...
export default class GameLevel extends Scene {
    ...
    updateScene(deltaT: number): void {
        ...
        if(!this.isPaused) {
            ...
            if((this.player.position.y > this.viewportMover.position.y + 155) && !this.isDead) {
    ...
    addPauseUI(): void {
        ...
        resume.borderColor = Color.TRANSPARENT;
        resume.backgroundColor = new Color(0, 0, 0, 0.1);
        ...
        exit.backgroundColor = new Color(0, 0, 0, 0.1);
    ...
    initializePlayer(): void {
        ...
        let inventory = new WeaponManager(this, 6, "inventorySlot", new Vec2(348, 15), 1.5);
    ...
    initializeEnemies(){
        ...
        for(let i = 0; i < enemyData.numEnemies; i++){
            ...
            let enemyOptions = {
                ...
                weapon2: this.createWeapon("weak_autoshotgun")
            }
